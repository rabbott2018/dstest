...
class Tenant(object):
    ...
    def __init__(self, database_server_id=None, name=None, description=None, agent_initiated_activation_password=None, time_zone=None, locale=None, demo_mode=None, modules_visible=None, hide_unlicensed_modules=None, last_signin_time=None, tenant_state=None, activation_codes=None, administrator=None, guid=None, id=None):  # noqa: E501
    ...
    def modules_visible(self, modules_visible):
        ...
        :type: list[str]
        """
        allowed_values = ["all", "anti-malware", "web-reputation", "firewall", "intrusion-prevention", "integrity-monitoring", "log-inspection", "application-control", "SAP"]  # noqa: E501
    ...
    def tenant_state(self, tenant_state):
        ...
        :type: str
        """
        allowed_values = ["undefined", "created", "active", "suspended", "pending-deletion", "db-upgrade-failure", "confirmation-required", "cache-requires-initialization", "cache-initializing", "cache-ready-for-use", "cache-activating"]  # noqa: E501
    ...
    def administrator(self):
        ...
        Primary contact of the tenant. Only username, password and emailAddress will be used.  # noqa: E501
