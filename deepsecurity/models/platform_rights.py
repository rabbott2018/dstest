...
class PlatformRights(object):
    ...
    def __init__(self, administrator_rights=None, administrator_role_rights=None, alert_configuration_rights=None, alert_rights=None, certificate_rights=None, computer_rights=None, contact_rights=None, diagnostic_rights=None, asset_value_rights=None, license_rights=None, multi_tenant_rights=None, policy_rights=None, port_list_rights=None, proxy_rights=None, relay_group_rights=None, scan_cache_rights=None, scheduled_task_rights=None, schedule_rights=None, setting_rights=None, syslog_configuration_rights=None, system_information_rights=None, tagging_rights=None, update_rights=None, apikey_rights=None, iplist_rights=None, samlidentity_provider_rights=None):  # noqa: E501
